...
/* harmony import */ var _auth_helpers_63cc23c0_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./auth-helpers-63cc23c0.js */ "./node_modules/@aws-amplify/ui-components/dist/esm/auth-helpers-63cc23c0.js");
...
const AmplifyConfirmSignIn = class {
    ...
    async confirm(event) {
        ...
        try {
            ...
            await Object(_auth_helpers_63cc23c0_js__WEBPACK_IMPORTED_MODULE_7__["c"])(this.user, this.handleAuthStateChange);
        }
        catch (error) {
...
const AmplifyConfirmSignUp = class {
    ...
    handleFormFieldInputChange(fieldType) {
        switch (fieldType) {
            ...
            case 'phone_number':
                return event => Object(_helpers_09e7c279_js__WEBPACK_IMPORTED_MODULE_6__["h"])(event, this.phoneNumber);
            case 'code':
    ...
    async confirmSignUp(event) {
        ...
        try {
            ...
            if (this._signUpAttrs && this._signUpAttrs.password && this._signUpAttrs.password !== '') {
                ...
                await Object(_auth_helpers_63cc23c0_js__WEBPACK_IMPORTED_MODULE_7__["h"])(this.userInput, this._signUpAttrs.password, this.handleAuthStateChange);
            }
            else {
        ...
        try {
            ...
            switch (user.challengeName) {
                ...
                case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["C"].MFASetup:
                    ...
                    break;
                default:
                    await Object(_auth_helpers_63cc23c0_js__WEBPACK_IMPORTED_MODULE_7__["c"])(user, this.handleAuthStateChange);
            }
        }
        catch (error) {
            Object(_helpers_09e7c279_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
...
const AmplifySignIn = class {
    ...
    async signIn(event) {
        ...
        await Object(_auth_helpers_63cc23c0_js__WEBPACK_IMPORTED_MODULE_7__["h"])(username, this.signInAttributes.password, this.handleAuthStateChange);
        this.loading = false;
    }
    buildDefaultFormFields() {
    ...
    async signUp(event) {
        ...
        try {
            ...
            if (data.userConfirmed) {
                await Object(_auth_helpers_63cc23c0_js__WEBPACK_IMPORTED_MODULE_7__["h"])(this.signUpAttributes.username, this.signUpAttributes.password, this.handleAuthStateChange);
            }
            else {
