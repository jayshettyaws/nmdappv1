...
const AmplifyAuthenticator = class {
        ...
        this.handleExternalAuthEvent = ({ payload }) => {
            switch (payload.event) {
                ...
                case 'customGreetingSignOut':
                    return Object(_helpers_09e7c279_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this.initialAuthState);
            }
        };
    ...
    async componentWillLoad() {
        Object(_helpers_09e7c279_js__WEBPACK_IMPORTED_MODULE_6__["o"])((authState, authData) => {
